...
# Work around relative paths breaking when packaged using PyInstaller.
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.settings_button.setIcon(QIcon(os.path.join(basedir, 'icons', 'settings.png')))
        ...
        self.pin_button.setIcon(QIcon(os.path.join(basedir, 'icons', 'pin.png')))
